...
CREATE TABLE `roles` (
  ...
  `role_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user',
  PRIMARY KEY (`id`),
...
INSERT INTO `todos` VALUES (4,'Hoc JAVA','Đọc tài liệu và làm bài','in_progress','2026-04-21 00:32:39','2026-04-21 11:34:21',1),(5,'Hoc ngôn ngữ C','Làm theo hướng dẫn','pending','2026-04-21 10:19:50','2026-04-21 10:19:50',1),(6,'Hoc Tiếng Anh','Start Learning','pending','2026-04-21 11:33:05','2026-04-21 11:33:05',1),(7,'Tiếng Trung','Start Learning','done','2026-04-21 11:33:25','2026-04-21 11:33:25',1),(14,'Giữa làn sóng','Giữa làn sóng công ty chứng khoán gắn với ngân hàng (như TCBS, VPBankS), CTCP Chứng khoán SSI (HOSE: SSI) đi theo hướng ngược lại khi xây dựng quan hệ với toàn hệ thống tín dụng. Với tổng hạn mức 110.000 tỷ đồng và tài sản gần 94.000 tỷ đồng, doanh nghiệp của ông Nguyễn Duy Hưng đặt nền tảng cho tham vọng đón dòng vốn ngoại quy mô lớn khi thị trường nâng hạng.','pending','2026-04-24 09:17:53','2026-04-24 09:18:08',1);
...
-- Dump completed on 2026-05-07 15:59:17
